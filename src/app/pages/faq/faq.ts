...
export class Faq {
  faqs: FaqItem[] = [
    {
      question: 'How does the HVAC quote process work?',
      answer: 'Fill out our detailed form with your HVAC project information. We securely process your data and connect you with trusted contractors in your area who will provide personalized quotes.',
      isOpen: false
    },
    {
    ...
    },
    {
      ...
      answer: 'We partner only with experienced, trusted HVAC professionals who have proven track records, positive customer reviews, and meet our quality standards. All contractors undergo background checks.',
      isOpen: false
    },
    {
    ...
    },
    {
      ...
      answer: 'We cover all major HVAC services including installation, repair, replacement, maintenance, and emergency repairs for various HVAC systems like central air, furnaces, and ductless mini-splits.',
      isOpen: false
    },
    ...
    },
    {
      ...
      answer: 'Basic project details including hvac type, property type, project nature (install/repair/replace), timeline, and contact information. More details help contractors provide accurate quotes.',
      isOpen: false
    }
  ];
